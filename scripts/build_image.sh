...
uboot="$OUTPUT/u-boot-with-dtb.bin"
...
cp -rfa $OUTPUT/Image $OUTPUT/orangepi
cp -rfa $OUTPUT/OrangePiA64.dtb $OUTPUT/orangepi/OrangePi-A64.dtb

# Add boot support if there
if [ -e "$OUTPUT/orangepi/Image" -a -e "$OUTPUT/orangepi/OrangePi-A64.dtb" ]; then
