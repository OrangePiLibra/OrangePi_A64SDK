...
echo -e "\e[1;32m 0. OrangePi win \e[0m"
...
echo -e "\e[1;32m 2. Build Uboot \e[0m"
echo -e "\e[1;32m 3. Build Linux \e[0m"
echo -e "\e[1;32m 4. Build Kernel only\e[0m"
echo -e "\e[1;32m 5. Build Module only \e[0m"
echo -e "\e[1;31m ================================== \e[0m"
echo -e "\e[1;31m If update Image, pls use root \e[0m"
echo -e "\e[1;31m ================================== \e[0m"
echo -e "\e[1;32m 6. Install Image into SDcard \e[0m"
echo -e "\e[1;32m 7. Update kernel Image \e[0m"
echo -e "\e[1;32m 8. Update Module \e[0m"
echo -e "\e[1;32m 9. Update Uboot \e[0m"
...
if [ $OPTION = "0" -o $OPTION = "1" ]; then
	...
	clear
	echo -e "\e[1;31m ================================== \e[0m"
	echo -e "\e[1;31m Succeed to build Uboot \e[0m"
	echo -e "\e[1;31m ================================== \e[0m"
	exit 0
elif [ $OPTION = "3" ]; then
	export BUILD_KERNEL=1
